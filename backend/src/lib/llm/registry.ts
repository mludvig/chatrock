...
import { bedrockResponsesProvider } from './providers/bedrockResponses'

export const CHAT_PROVIDERS: ChatProvider[] = [bedrockConverseProvider, bedrockResponsesProvider]
