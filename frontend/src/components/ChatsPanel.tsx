...
export default function ChatsPanel() {
  ...
  return <section className="chats-panel" aria-label="Recent chats">
    ...
    <div className="chat-list">{sortByRecent(filterPrivateChats(chats, showPrivate)).map(c => <div key={c.chatId} className={`chat-item unified-chat-row navigation-row${c.chatId === active ? ' active' : ''}${c.sensitive ? ' sensitive' : ''}`}>
